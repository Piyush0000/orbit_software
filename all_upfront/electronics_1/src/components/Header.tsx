  ...
  return (
    <>
      ...
      <div 
        ...
        className="bg-[#E7F874] text-black text-xs sm:text-sm font-semibold py-2.5 text-center px-4 tracking-wide relative z-[51] hover:outline hover:outline-2 hover:outline-blue-500/50 cursor-pointer"
      >
        {announcementText}
      </div>
      ...
      <header
        ...
        className="sticky top-0 z-50 border-b transition-colors duration-300 backdrop-blur-md bg-white/90 supports-[backdrop-filter]:bg-white/50 hover:outline hover:outline-2 hover:outline-blue-500/50 cursor-pointer"
        style={{
