                ...
                return (
                    <div className="space-y-6 animate-fadeIn">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div className="bg-yellow-50 p-6 rounded-lg text-center cursor-pointer hover:bg-yellow-100 transition-colors">
                                <h3 className="text-2xl font-bold text-yellow-600">{wishlist.length}</h3>
                ...
                return (
                    <div className="animate-fadeIn">
                        ...
                        <div className="bg-white rounded-lg border border-gray-200 p-8 text-center">
                            ...
                            <Link href="/#products" className="bg-[#E7F874] text-black px-8 py-3 rounded text-sm font-bold uppercase tracking-wider hover:bg-[#d9ea65] transition-colors inline-block shadow-lg shadow-yellow-100">Start Shopping</Link>
                        </div>
