...
import { ShoppingCart, Search, Menu, Heart, User, ShoppingBag, X, ChevronDown } from "lucide-react";
    ...
    return (
        <>
            ...
            <div
                ...
                className={cn(
                    "fixed left-0 right-0 z-40 bg-secondary text-white text-center py-2 transition-all duration-300 hover:outline hover:outline-2 hover:outline-blue-500/50 cursor-pointer",
