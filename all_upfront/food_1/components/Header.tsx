...
export default function Header() {
    ...
    return (
        <header 
            ...
            className="sticky top-0 z-50 w-full border-b bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60 hover:outline hover:outline-2 hover:outline-blue-500/50 cursor-pointer"
        >
            {announcementText && (
                <div 
