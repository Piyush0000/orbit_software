        ...
        <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center bg-background px-4 py-20">
            <Card className="w-full max-w-md border-border shadow-2xl overflow-hidden bg-card">
                ...
                <CardContent className="space-y-8 pt-10 px-10 pb-10">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="relative">
                                <Input
                                    ...
                                    type="text"
                                    className="pl-10 h-14 bg-muted border-border focus:ring-primary text-base"
                                />
                    ...
                    <div className="relative py-4">
                        ...
                        <div className="relative flex justify-center text-xs uppercase">
                            <span className="bg-card px-4 text-muted-foreground font-bold tracking-widest">Or sign up with</span>
                        </div>
                    </div>

                    <Button variant="outline" className="w-full h-14 border-border hover:bg-muted transition-colors text-base font-bold">
                ...
                <CardFooter className="flex flex-col space-y-6 pb-12 px-10 text-center pt-8 border-t border-zinc-100">
                    <div className="flex items-center justify-center gap-2 text-muted-foreground bg-muted py-2 px-4 rounded-full w-fit mx-auto">
