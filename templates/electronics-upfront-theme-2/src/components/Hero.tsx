...
export default function Hero() {
  ...
  const heroTitle = hero.title || 'FUTURE';
  const heroSubtitle = hero.subtitle || 'READY';
  const heroDescription =
    hero.description ||
    'Experience the next generation of tech. Get up to 70% OFF on selected models.';
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-white">
        <div className="max-w-3xl animate-fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row gap-6">
            ...
            >
              <span className="skew-x-[10deg] inline-block">{hero.ctaText || 'SHOP NOW'}</span>
            </a>
            <a
              href="#featured"
            ...
            >
              <span className="skew-x-[10deg] inline-block">{hero.secondaryCtaText || 'EXPLORE'}</span>
            </a>
          </div>
        </div>
      </div>
