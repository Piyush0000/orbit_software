...
const THEMES = [
  ...
  { value: "electronics-upfront", label: "Tech Gear - Upfront", category: "electronics" },
  { value: "electronics-upfront-theme-2", label: "Tech Gear - Upfront 2", category: "electronics" },
